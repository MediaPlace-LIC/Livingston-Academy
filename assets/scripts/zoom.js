  ...
  function mouseDown(e) {
    ...
    if (doubleClickMonitor[0] === null) {
      ...
      if (hasClass($container, _active) === true) {
        ...
        moveScaleElement($element, 0, 0, 1, 0, 0);
      } else {
        ...
        imageCenterX = elementWidth / 2;
        imageCenterY = elementHeight / 2;
        ...
        if (targetScale < 1) {
          ...
          targetOffsetX = ((imageCenterX - pointerOffsetX) * targetScale) + (28 * targetScale);
          targetOffsetY = (((imageCenterY - (pointerOffsetY - containerOffsetY)) ) * targetScale) - (25 * targetScale);
        }

        //console.log('elementHeight ' + elementHeight);
        //console.log('imageCenterY ' + imageCenterY);
        //console.log('pointerOffsetY ' + pointerOffsetY);
